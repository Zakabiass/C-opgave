...
namespace Mozarts_Vals_generator
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // array for minuets
            int[,] minuets = { { 96, 22, 141, 41, 105, 122, 11, 30, 70, 121, 26, 9, 112, 49, 109, 14 },
            ...
            {
                //gør at programmet kan fnide filerne
                string[] filePath = new string[175];
                for (int i = 0; i <= filePath.Length; i++)
                {
                    filePath[i] = @"C:\Users\Zakarias Sonne\Downloads\Wave\Wave\" + "M" + (i + 1) + ".wav";

                }
                filePath = new string[95];
                for (int i = 0; i <= trios.Length; i++)
                {
                    filePath[i] = @"C:\Users\Zakarias Sonne\Downloads\Wave\Wave\" + "T" + (i + 1) + ".wav";
                }
